    ...
    <nav id="wd-account-nav" className="pt-2">
      {!currentUser && (
        <>
          <Link
            href="/Account/Signin"
            className={itemCls(isActive("/Account/Signin"))}
          >
            Signin
          </Link>
          <Link
            href="/Account/Signup"
            className={itemCls(isActive("/Account/Signup"))}
          >
            Signup
          </Link>
        </>
      ...
      {currentUser && (
        <>
          <Link
            ...
            className={itemCls(isActive("/Account/Profile"))}
          >
            Profile
          </Link>
          ...
          {currentUser.role === "ADMIN" && (
            <Link
              href="/Account/Users"
              className={itemCls(isActive("/Account/Users"))}
            >
              Users
            </Link>
          )}
